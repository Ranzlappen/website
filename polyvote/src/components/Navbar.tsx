  ...
  return (
    <header className="sticky top-0 z-50 border-b border-surface-200 bg-surface/80 backdrop-blur-md">
      <div className="mx-auto flex h-14 max-w-6xl items-center justify-between gap-2 px-4">
        ...
        >
          {/* Scrollable primary nav — prevents the header from exceeding
              viewport width when the Claim Admin pill is visible. */}
          <div className="flex min-w-0 flex-nowrap items-center gap-0.5 overflow-x-auto scrollbar-none sm:gap-1">
            <a
              href="/"
          ...
          {/* Auth cluster stays outside the scroll container so the login
              dropdown isn't clipped by overflow-x-auto. */}
          <div className="flex shrink-0 items-center gap-0.5 sm:gap-1 pl-1 sm:pl-2">
            <span className="mx-1 h-4 w-px bg-surface-200" aria-hidden="true" />
